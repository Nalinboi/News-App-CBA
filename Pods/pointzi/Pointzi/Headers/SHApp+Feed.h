...
/**
 Send no priority logline for feed result.
 @param feed_id The feed id of result feed.
 @param dictResult The result for accept, or postpone or decline.
 */
- (void)notifyFeedResult:(NSString *)feed_id withResults:(nonnull NSDictionary *)dictResult ;
...
- (void)notifyFeedResultOnError:(nonnull NSString *)feed_id
          withCampaignId:(nullable NSString *)campaignid
          withTipType:(nonnull NSString *)tipType
           withStepId:(nullable NSString *)stepId
           withMessage:(nullable NSString *)message;
            
- (void)pollingPendingFeeds:(NSTimer *_Nullable)timer;
- (void) fetchPendingFeeds ;
- (void) startFeedPolling;
- (void) cancelFeedPolling;
- (NSMutableArray *)filterNewFeeds:(NSArray * _Nullable)arrayFeeds;
@end
