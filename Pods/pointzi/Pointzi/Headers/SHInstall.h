...
/**
 Create a SHInstall with `installid`, which is unique id of the install in server.
 since IOS-1272 installid should be generated and reserved locally
 @param installid Unique primary key match to StreetHawk server. This cannot be empty.
 */
- (void)setupInstallid:(NSString *)installid;
...
/**
 * Customer developer register installid in streethawk server.
 * Since IOS-1272 installid should be generated and reserved locally
 */
