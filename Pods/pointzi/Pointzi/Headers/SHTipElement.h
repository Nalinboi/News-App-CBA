...
/**
 Interactions of the tip.
 */
@property (nonatomic, strong) NSArray <SHTipInteractions*> *arrayInteractions;


/**
 Overlay for the tip.
 */
@property (nonatomic, strong) SHOverlay *overlay;
