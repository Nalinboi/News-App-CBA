...
@class PointziBaseViewController;
@compatibility_alias StreetHawkBaseViewController PointziBaseViewController;

@class PointziTableViewController;
@compatibility_alias StreetHawkBaseTableViewController PointziTableViewController;

@class PointziCollectionViewController;
@compatibility_alias StreetHawkBaseCollectionViewController PointziCollectionViewController;
 ...
 */
@interface StreetHawkBaseViewController : UIViewController <ISHDeepLinking,UIAdaptivePresentationControllerDelegate,UIScrollViewDelegate>
 ...
 */
@interface StreetHawkBaseTableViewController : UITableViewController <ISHDeepLinking,UIAdaptivePresentationControllerDelegate>
 ...
 */
@interface StreetHawkBaseCollectionViewController : UICollectionViewController <ISHDeepLinking,UIAdaptivePresentationControllerDelegate>
